...
/*
#define DEV_MFR   	"ASUSTek"
#define DEV_MFR_URL     "http://www.asus.com/"
#define DEV_MODEL_DESCRIPTION  "ASUS Wireless Access Point"
#define DEV_MODEL  "WLAN Access Point"
#define DEV_MODEL_NO nvram_safe_get("productid") 
#define DEV_MODEL_URL     "http://www.asus.com/"
*/

#define DEV_MFR			nvram_safe_get("DEV_MFR")
#define DEV_MFR_URL		nvram_safe_get("DEV_MFR_URL")
#define DEV_MODEL_DESCRIPTION	"Pocket Wireless Access Point"
#define DEV_MODEL		"WLAN Access Point"
#define DEV_MODEL_NO		nvram_safe_get("productid")
#define DEV_MODEL_URL		nvram_safe_get("DEV_MODEL_URL")
...
void device_xml(PDevice pdev, UFILE *up)
{
	...
	uprintf(up, "<manufacturerURL></manufacturerURL>\r\n");
