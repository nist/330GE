...
/*      Global vars.
 */
char ft_src[] __initdata = "$Source: /home/user/WL520gu/src/linux/linux/drivers/char/ftape/lowlevel/ftape-init.c,v $";
char ft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char ft_dat[] __initdata = "$Date: 2007/01/25 12:51:53 $";
