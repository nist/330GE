...
char zft_src[] __initdata = "$Source: /home/user/WL520gu/src/linux/linux/drivers/char/ftape/zftape/zftape-init.c,v $";
char zft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char zft_dat[] __initdata = "$Date: 2007/01/25 12:51:53 $";
