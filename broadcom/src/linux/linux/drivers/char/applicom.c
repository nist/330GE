...
/* $Id: applicom.c,v 1.1.1.1 2007/01/25 12:51:52 jiahao_jhou Exp $			     */
...
int __init applicom_init(void)
{
	...
	printk(KERN_INFO "Applicom driver: $Id: applicom.c,v 1.1.1.1 2007/01/25 12:51:52 jiahao_jhou Exp $\n");
