...
// Joey: make min threshold higher
//static int zone_balance_min[MAX_NR_ZONES] __initdata = { 20 , 20, 20, };
static int zone_balance_min[MAX_NR_ZONES] __initdata = { 40 , 40, 40, };
//static int zone_balance_min[MAX_NR_ZONES] __initdata = { 128 , 128, 128, };
