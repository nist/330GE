 ...
 *
 * $Id: network.c,v 1.1.1.1 2007/01/25 12:52:51 jiahao_jhou Exp $
 */
...
#ifdef RPPPPOE
		else if (nvram_match("wan_proto", "pppoe") || nvram_match("wan_proto", "pptp")) 
		{
...
#if 0 
	else if (strcmp(wan_proto, "cdma")==0)
        {
//                printf("!!!Start CDMA!!!\n");
                start_cdma();
                update_wan_status(0);
...
wan_down(char *wan_ifname)
{
	...
	update_wan_status(0);
#ifdef CDMA
	if ((strcmp(wan_proto, "bigpond")==0) || (strcmp(wan_proto, "cdma") == 0)) {
#else
	if (strcmp(wan_proto, "bigpond")==0){
