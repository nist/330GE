...
function copy_value()
{
	if (document.form.wl_client!=null && document.form.wl_client.value.length!=0)
		document.form.wl_maclist_x_0.value=document.form.wl_client.value;
}
...
<tr>
	...
	<td class="content_input_td" nowarp="nowarp">
		<select name="wl_client" class="content_input_fd">
			<% nvram_dump("client_list.log",""); %>
		</select>&nbsp;
			<input type="button" style="cursor:pointer;" class="inputSubmit" onClick="copy_value()" value="<#CTL_add_known_client#>" name="add_known_client">
	</td>
</tr>
</table>
</td>
