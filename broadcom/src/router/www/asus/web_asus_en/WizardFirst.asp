...
<p><input class=inputSubmit style="cursor:pointer;" onMouseOut=buttonOut(this) onMouseOver=buttonOver(this) type="button" onClick="redirect()" value="<#CTL_next#>" name="action"></p>
</td>
</tr>
</tbody>
</table>
