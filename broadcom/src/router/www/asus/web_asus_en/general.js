...
function markGroup(o, s, c, b) {
	...
	if (b == " Add ")
	{
		...
		else if (s == 'MFList') // MAC filter List 
		{
			if (document.form.wl_macnum_x_0.value >= c) cFlag=1;
	...
	{
		// Check if inserted item is validated
		if (s=='ProfileList') // Wireless Bridge
		{
			...
			if (document.form.exmode.value != "ap")
			{
				...
				inputCtrl(document.form.wl_key_type, 1);	// key_type patch by Jiahao
...
function validate_string(o)
{
  if (!o.value)
  {
//  	alert("called by "+validate_string.caller);
	return true;
  }
...
function validate_string2(o)	// for Host name checking
{
...
function validate_string3(o)	// for address checking
{
	if (!validate_string(o))
	{
		return false;
...
function validate_string4(o)	// for SSID checking
{		
	for(i=0;i<o.value.length;i++)
	{
		c = o.value.charCodeAt(i);
...
//		o.value = document.form.wl_ssid_org.value;
  ...
  else if (document.form.current_page.value == "Advanced_WirelessGuest_Content.asp")
  {
	...
	{
//		o.value = document.form.wl_guest_ssid_org.value;
...
function validate_ipaddr2(o, v)
{
  ...
  if (o.value.length==0) // check for blank ip
  {
//  	alert("Fields can't be blank!!!");
	alert(translate_lang('JS_fieldblank',document.form.preferred_lang.value));
  	o.focus();
...
//   		inputCtrl(document.form.wl_channel, 0);
	...
	if (document.form.exmode.value != "ap")
	{
		...
		{
//			inputCtrl(document.form.wl_ap_index, 1);
		...
		{
//			inputCtrl(document.form.wl_ap_index, 0);
...
//   		document.form.next_page.value = "Advanced_WirelessMSSID_Content.asp";
		document.form.next_page.value = "Advanced_WAdvanced_Content.asp";
   	else if (document.form.wan_route_mode.value == "IP_Bridged" && document.form.exmode.value == "re")
   		document.form.next_page.value = "Advanced_WAdvanced_Content_URE.asp";
   ...
   else if (document.form.current_page.value == "Advanced_WirelessGuest_Content.asp" )
   {
	...
	document.form.wl_guest_key4_1.value = decodeURIComponent(document.form.wl_guest_key4_1_org.value);
   	...
   	final_flag = 1; // disable onBlur validate_ip check
//   	masq_wepkey_guest();
   ...
   else if (document.form.current_page.value == "Advanced_WMode_Content.asp")
   {
	...
	else
	{
    		change_wireless_bridge(document.form.wl_mode_x.value,
  				rcheck(document.form.wl_wdsapply_x),
//  				rcheck(document.form.wl_lazywds), 0);	// for BCM5354
				"0", 0);	// for BCM5354
  	}
   }
   else if (document.form.current_page.value == "Advanced_WAdvanced_Content.asp")
...
//	inputRCtrl2(document.form.wl_lazywds, 1);	// for BCM5354
	inputRCtrl1(document.form.wl_wdsapply_x, 0);
//	inputRCtrl1(document.form.wl_lazywds, 0);	// for BCM5354
    }
    else
    {
	if (a=="0" && r == "0")
...
//	inputRCtrl1(document.form.wl_lazywds, 1);	// for BCM5354
...
function onSubmit()
{
   ...
   else if (document.form.current_page.value == "Advanced_WAdvanced_Content.asp")
   {
	if (!validate_string4(document.form.wl_guest_ssid_1))
   	...
   	inputCtrl(document.form.wl_guest_key_type_1, 1);	// key_type patch by Jiahao
...
//	if (document.form.wl_mode_ex.value == "sta")
//	{
//		document.form.wl_nat.value = document.form.wan_nat.value;
//	}
...
//   		inputCtrl(document.form.wl_ap_index, 1);
	...
	if (document.form.exmode.value != "ap")
	{
		...
		inputCtrl(document.form.wl_key_type, 0);	// key_type patch by Jiahao
...
function change_common(o, s, v)
{
  ...
  else if (v == "wl_key_type")	// key_type patch by Jiahao
  {
...
// 	else change_wireless_bridge(o.value, rcheck(document.form.wl_wdsapply_x), rcheck(document.form.wl_lazywds), 1);	// for BCM534
	else change_wireless_bridge(o.value, rcheck(document.form.wl_wdsapply_x), "0", 1);	// for BCM534
  }
  else if (v == "wl_crypto")
  {
  	wl_auth_mode_change(0);
  ...
  else if (v == "wl_guest_key_type_1")	// key_type patch by Jiahao
  {
...
//  	else change_wireless_bridge(document.form.wl_mode_x.value, r, rcheck(document.form.wl_lazywds), 0);	// for BCM5354
	else change_wireless_bridge(document.form.wl_mode_x.value, r, "0", 0);	// for BCM5354
  }
...
function change_wlweptype(o, s)		// key_type patch by Jiahao
{
...
function change_wlweptype_sp(o, s)		// key_type patch by Jiahao
{
	if (document.form.wl_auth_mode.value!="psk")
	{
  		change = 1;
...
function is_wlkey(o, s)		// key_type patch by Jiahao
{
	if (!nav)
		keyPressed = IEKey();
	else
...
function change_wlkey(o, s)	// key_type patch by Jiahao
{
	if (	document.form.current_page.value == "Advanced_WirelessGuest_Content.asp" ||
		document.form.current_page.value == "Advanced_WAdvanced_Content.asp"
	)
...
function validate_wlkey(o, s)	// key_type patch by Jiahao
{
	if (	document.form.current_page.value == "Advanced_WirelessGuest_Content.asp" ||
		document.form.current_page.value == "Advanced_WAdvanced_Content.asp"
	)
...
//	alert(translate_lang('JS_wepkey',document.form.preferred_lang.value));
	if (wep == "1")
	{
		if (key_type == "0")
...
function validate_wlkey_sp(o, s)	// key_type patch by Jiahao
{
	if (	document.form.current_page.value == "Advanced_WirelessGuest_Content.asp" ||
		document.form.current_page.value == "Advanced_WAdvanced_Content.asp"
	)
...
function validate_wlphrase(s, v, o)
{
   if (v == "wl_wpa_psk" || v == "wl_guest_wpa_psk_1" || v== "mssid_wpa_psk_x_0")
   {
	  ...
	  )
   	{
   	   if (o.value.length < 8)
   	   {
//   	      alert("Pre-shared key should be more than 7 characters!!! If you leave this field blank, system will assign 12345678 as your passphrase.");
...
/* output: wep key1~4						*/
function is_wlphrase(s, v, o)		// key_type patch by Jiahao
{
	window.top.pageChanged = 1;
...
//  	   if(window.top.isModel3()!='WL550gE' && window.top.isModel3()!='WL320g')
...
//		 || mode == "radius")
		{
			...
			inputCtrl(document.form.wl_guest_key_type_1, 0);	// key_type patch by Jiahao
...
//		else algos = new Array("TKIP", "AES", "TKIP+AES");
	...
	if ((mode == "wpa" || mode == "wpa2" || mode == "psk"))
	{
		if (window.top.isModel()=="WL520" || window.top.isModel()=="SnapAP" || window.top.isBand()=='b' )
		{
  		...
  		{
  			document.form.wl_guest_wep_x_1.value = 0;
  			//change_wlweptype_guest(document.form.wl_wep_x, "WLANConfig11b");
...
function change_wlweptype_guest(o, s)		// key_type patch by Jiahao
{
...
function change_wlweptype_guest_sp(o, s)		// key_type patch by Jiahao
{
	if (document.form.wl_guest_auth_mode_1.value!="psk")
	{
		change = 1;
