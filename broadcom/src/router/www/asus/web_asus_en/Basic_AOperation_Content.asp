...
<input type="hidden" name="next_page" value="Main_Operation4.asp">
...
<tr bgcolor="#FFFFFF">  
   ...
   <td height="25" width="33%">  
   <div align="center">
   <font face="Arial"><input class=inputSubmit style="cursor:pointer;" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="toPrevTag('Wireless')" type="hidden" value="<#CTL_prev#>" name="action1"></font>&nbsp;&nbsp;&nbsp;&nbsp;
