      ...
      <ul>
       ...
       <li> <b><a href="javascript:top.openBranch('USB Application')">USB Application</a>
        ...
        <li> <b><a href="javascript:top.openBranch('Status & Log')">Status &amp; Log</a></b> 
         ...
         <i><FONT style="color: #0000ff; font-size: 10pt;">This site is best viewed with IE 5.5 or above.</FONT></i>  
        </p>
        <p><font face="Arial"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        &nbsp;&nbsp;      
        <font style="color: #000000; font-size: 10pt;"><b>Click NEXT to start Quick Setup</b></font>&nbsp; </font><input class=inputSubmit style="cursor:pointer;" onMouseOut=buttonOut(this) onMouseOver=buttonOver(this) type="submit" value="NEXT" name="action">       
        </p>
        <p></p>
      </ul>
    </td>
