...
<ul>
<li>
<p style="word-spacing: 0; margin-top: 0; margin-bottom: 0"> <a href="javascript:top.openBranch('<#t1Wizard#>')"><b><#t1Wizard#></b></a>
<#HP_quick_desc_sp#></li>
...
<p><font face="Arial">
<font style="color: #000000; font-size: 10pt;"><b><#HP_desc2_sp#></b></font>&nbsp; </font><input class=inputSubmit style="cursor:pointer;" onMouseOut=buttonOut(this) onMouseOver=buttonOver(this) type="submit" onClick="top.openBranch('<#t1Wizard#>')" value="<#CTL_next#>" name="action">
</p>
<p></p>
</ul>
</td>
