...
<tr>
	<td class="content_desc_td" colspan="2"><#DeviceSecurity11a_display1_sectiondesc#></td>
</tr>
<tr>
	<td class="content_header_td"><#DeviceSecurity11a_ACLMethod_itemname#></td>
	<td class="content_input_td">
		<select name="wl_macmode" class="content_input_fd" onChange="return change_common(this, 'DeviceSecurity11a', 'wl_macmode')">
			<option class="content_input_fd" value="disabled" <% nvram_match_x("DeviceSecurity11a","wl_macmode", "disabled","selected"); %>>Disable</option>
			<option class="content_input_fd" value="allow" <% nvram_match_x("DeviceSecurity11a","wl_macmode", "allow","selected"); %>>Accept</option>
			<option class="content_input_fd" value="deny" <% nvram_match_x("DeviceSecurity11a","wl_macmode", "deny","selected"); %>>Reject</option>
		</select>
	</td>
</tr>
<tr>
	<td class="content_header_td"><#DeviceSecurity11a_KnownClientList_itemname#></td>
	<td class="content_input_td">
		<select name="wl_client" class="content_input_fd" onChange="return change_common(this, 'DeviceSecurity11a', 'wl_client')">
			<% nvram_dump("client_list.log",""); %>
		</select>
	</td>
</tr>
</table>
...
<tr class="content_list_header_tr">
	<td class="content_list_header_td" width="60%" id="ACLList"><#DeviceSecurity11a_ACLList_groupitemdesc#>
		...
		<div align="center">
		<input class="inputSubmit" style="cursor:pointer;" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'ACLList', 64, ' Add ');" name="ACLList" value="<#CTL_add#>" size="12">
		</div>
	</td>
	<td width="10%">
		<div align="center">
		<input class="inputSubmit" style="cursor:pointer;" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'ACLList', 64, ' Del ');" name="ACLList" value="<#CTL_del#>" size="12">
		</div>
	</td>
	<td width="5%"></td>
</tr>
	...
	<tr>
		...
		<tr>
			<td></td>
			<td class="content_list_field_header_td" colspan=""><#DeviceSecurity11a_MacAddr_itemname#></td>
			<td></td>
		</tr>
		<tr>
			<td></td>
			<td class="content_list_input_td" colspan="">
				<input type="text" maxlength="12" class="content_input_list_fd" size="32" name="wl_maclist_x_0" onKeyPress="return is_hwaddr()">
			</td>
		</tr>
		<tr>
			<td></td>
			<td colspan="10">
				<select size="8" name="ACLList_s" multiple="true" style="font-family: fixedsys; font-size: 8pt;">
