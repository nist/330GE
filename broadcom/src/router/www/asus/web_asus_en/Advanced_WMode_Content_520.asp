...
<div align="center">
<input class="inputSubmit" type="submit" style="cursor:pointer;" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'RBRList', 4, ' Add ');" name="RBRList" value="<#CTL_add#>" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" style="cursor:pointer;" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'RBRList', 4, ' Del ');" name="RBRList" value="<#CTL_del#>" size="12">
</div>
</td><td width="5%"></td>
</tr>
