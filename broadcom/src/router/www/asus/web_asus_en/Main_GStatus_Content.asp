...
<tr>
<td class="content_header_td_less"><#PPPConnection_x_WANAction_itemname#></td>
<td class="content_input_td">
<input type="submit" style="cursor:pointer;" maxlength="15" class="content_input_fd_ro" onClick="return onSubmitApply('dhcpc_release')" size="12" name="PPPConnection_x_WANAction_button" value="<#PPPConnection_x_WANAction_buttonname#>">
<input type="submit" style="cursor:pointer;" maxlength="15" class="content_input_fd_ro" onClick="return onSubmitApply('dhcpc_renew')" size="12" name="PPPConnection_x_WANAction_button1" value="<#PPPConnection_x_WANAction_button1name#>">
</td>
</tr>
</table>
</td>
