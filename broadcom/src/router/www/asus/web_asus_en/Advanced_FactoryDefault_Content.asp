...
<#DEF_desc#>
<p align="center" style="margin-bottom: 16"> <input class=inputSubmit style="cursor:pointer;" onMouseOut=buttonOut(this) onMouseOver="buttonOver(this)" onClick="onSubmitCtrlOnly(this, 'Restore')" type="submit" value="<#CTL_restore#>" name="action"></p>
</td></tr>
</table>
</td>
</tr>
