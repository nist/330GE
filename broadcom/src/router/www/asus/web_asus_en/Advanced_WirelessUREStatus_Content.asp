...
<form method="GET" name="form" action="apply.cgi">
            <input type="hidden" name="current_page" value="Advanced_WirelessUREStatus_Content.asp">
...
<td class="content_list_header_td" width="59%"><#WLANUREStatus_groupitemdesc#></td>
