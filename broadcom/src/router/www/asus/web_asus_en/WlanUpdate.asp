...
<tr bgcolor="#FFFFFF"><td class="content_desc_td"><font face="arial" size="2"><b>&nbsp</b></font>
    ...
    <p align="center" style="margin-bottom: 16"> <input class=inputSubmit style="cursor:pointer;" onMouseOut=buttonOut(this) onMouseOver="buttonOver(this)" onClick="onSubmitCtrl(this, 'WlanUpdate ')" type="submit" value="Update" name="action"></p>
  </td>
</tr>
</table>
</td>
