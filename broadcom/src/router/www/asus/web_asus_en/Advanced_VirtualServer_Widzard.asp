      ...
      <div align="center">
        ...
        <table border="2" width="98%" height="26" bordercolorlight="#008080" bordercolordark="#008080" bordercolor="#008080">
          ...
          <tr>
            ...
            <td width="35%" height="20"><input type="button" style="cursor:pointer;" value="Apply" name="Apply" onClick="apply();"></td>
            <td width="34%" height="20"><input type="button" style="cursor:pointer;" value="Cancel" name="Cancel" onClick="cancel();"></td>
          </tr>
        </table>
        </center>
      </div>           
