...
{  
   ...
   alert("Add to Bookmark:" + bookmarkurl);
...
<p>  
   ...
   <input class=inputSubmit style="cursor:pointer;" onClick="addbookmark()" type="button" style="cursor:pointer;" value="Add to Bookmark" name="action"></font></div> 
</p>
</td>
</tr>
<tr>
<td colspan="2"></td>
<td width="10" style="padding-top:2;padding-bottom:2;padding-left:2" onMouseOver="return overlib('Move cursor over image area Click left button of mouse to capture image. Click right button of mouse to record video and click right button again to stop recording.', CENTER, CAPTION, 'Tips for Active User');" onMouseOut="return nd();">
...
<b>
If you use "ActiveX and Refresh" mode and still can not see any image, please press link following to display in an alternate way.. <a href="javascript:openLink('x_WImageStatic')" name="PrinterStatus_x_WImageStatic_link">here</a>
</b>
</font>
</td>
</tr>
