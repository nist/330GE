          ...
          <tr bgcolor="#FFFFFF"> 
            <center>
              <td colspan="2" align="left" height="25"> 
                <p align="right"> 
                  <input class=inputSubmit style="cursor:pointer;" onMouseOut=buttonOut(this) onMouseOver=buttonOver(this) type=submit value=' Modify ' name="chgpwdbutton1">
                  <input class=inputSubmit style="cursor:pointer;" onMouseOut=buttonOut(this) onMouseOver=buttonOver(this) type=reset value='   Clear   ' name="reset">
                </p>
              </td>
            </center>
          </tr>
