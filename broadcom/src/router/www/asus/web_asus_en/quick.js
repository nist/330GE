...
function quick_translate_lang(o,v)
{
        ...
        {
                if(o=='JS_ADSL')
                        translated_string ="ADSL 모뎀연결을 선택하려면 두 개의 필드항목을 공란으로 할 수 없습니다.";
                else if(o=='JS_router_ip')
                        translated_string="고정 IP주소를 시스템에 할당해야 합니다!";
        }
        else if(v=='DE')
        {
                if(o=='JS_ADSL')
                        translated_string ="Wenn eine Verbindung mit einem ADSL Modem gewahlt wurde, durfen diese 2 Optionen nicht frei bleiben.";
                else if(o=='JS_router_ip')
                        translated_string="Fur das System sollte eine statische IP festgelegt werden!";
        }
        else if(v=='JP')
        {
                if(o=='JS_ADSL')
