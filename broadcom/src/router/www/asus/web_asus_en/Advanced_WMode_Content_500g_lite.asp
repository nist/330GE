...
<input type="hidden" name="vlans_enable" value="<% nvram_get_x("WLANConfig11b","vlans_enable"); %>">
...
<tr class="content_list_header_tr">
	...
	<td width="10%">
		<div align="center">
		<input class="inputSubmit" style="cursor:pointer;" type="button" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="subWin=window.open('Advanced_WirelessAPScanPre2_Content.asp','AS2','width=578,height=480')" name="apscan" value="<#CTL_apscan#>" size="12">
		</div>
	</td>
	<td width="10%">
		<div align="center">
		<input class="inputSubmit" style="cursor:pointer;" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'RBRList', 2, ' Add ');" name="RBRList" value="<#CTL_add#>" size="12">
		</div>
	</td>
	<td width="10%">
		<div align="center">
		<input class="inputSubmit" style="cursor:pointer;" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'RBRList', 2, ' Del ');" name="RBRList" value="<#CTL_del#>" size="12">
		</div>
	</td>
	<td width="5%">
	</td>
