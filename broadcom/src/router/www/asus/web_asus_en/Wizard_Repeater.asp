...
<input type="hidden" name="current_page" value="Wizard_Repeater.asp">
<input type="hidden" name="next_page" value="SaveRestart.asp">
<input type="hidden" name="next_host" value="">
<input type="hidden" name="group_id" value="">
<input type="hidden" name="action_mode" value="">
<input type="hidden" name="modified" value="0">
<input type="hidden" name="op_mode" value="repeater">
...
<input type="hidden" name="wl_mode_ex" value="re">
...
<input type="hidden" name="wl_individual_ure" value='0'>
<input type="hidden" name="add_profile" value='0'>
<input type="hidden" name="wl_afterburner" value='off'>
...
<td width="184"><div class="tag_on">Repeater</div></td>
</tr>
</table>
...
<div class="pic" style="background-image: url(graph/repeater_pic.gif); background-repeat: no-repeat;">
<script>
if (document.form.preferred_lang.value=="JP" || document.form.preferred_lang.value=="TR")
document.writeln('<div style=\"margin-left:30px; margin-top:30px; width:80px; font-weight:bold; font-family: Arial; font-size:13px; position:absolute;\"><#SW_user#></div>');
else if (document.form.preferred_lang.value!="DE")
document.writeln('<div style=\"margin-left:55px; margin-top:30px; width:50px; font-weight:bold; font-family: Arial; font-size:13px; position:absolute;\"><#SW_user#></div>');
else
document.writeln('<div style=\"margin-left:32px; margin-top:30px; width:50px; font-weight:bold; font-family: Arial; font-size:13px; position:absolute;\"><#SW_user#></div>');
</script>
<div style="margin-left:315px; margin-top:106px; width:70px; font-weight:bold; font-family: Arial; font-size:13px; position:absolute;"><#ZVMODELVZ#></div>
<!--
<div style="margin-left:530px; margin-top:110px; width:120px; font-weight:bold; font-family: Arial; font-size:13px; position:absolute;"><#DEVICE_AP#></div>
-->
<script>
if (document.form.preferred_lang.value=="TR")
document.writeln('<div style=\"margin-left:495px; margin-top:110px; width:120px; font-weight:bold; font-family: Arial; font-size:13px; position:absolute;\"><#DEVICE_AP#></div>');
else
document.writeln('<div style=\"margin-left:530px; margin-top:110px; width:120px; font-weight:bold; font-family: Arial; font-size:13px; position:absolute;\"><#DEVICE_AP#></div>');
</script>
<!--
<div style="margin-left:637px; margin-top:8px; width:60px; font-weight:bold; font-family: Arial; font-size:13px; position:absolute;"><#BM_Internet#></div>
-->
<script>
if (nav)
{if (document.form.preferred_lang.value=="JP")
document.writeln('<div style=\"margin-left:625px; margin-top:8px; width:98px; font-weight:bold; font-family: Arial; font-size:13px; position:absolute;\"><#BM_Internet#></div>');
else
document.writeln('<div style=\"margin-left:637px; margin-top:8px; width:60px; font-weight:bold; font-family: Arial; font-size:13px; position:absolute;\"><#BM_Internet#></div>');
}
else
{if (document.form.preferred_lang.value!="JP")
document.writeln('<div style=\"margin-left:637px; margin-top:8px; width:60px; font-weight:bold; font-family: Arial; font-size:13px; position:absolute;\"><#BM_Internet#></div>');
else
document.writeln('<div style=\"margin-left:625px; margin-top:8px; width:84px; font-weight:bold; font-family: Arial; font-size:13px; position:absolute;\"><#BM_Internet#></div>');
}
</script>
</div>
</div></td>
...
<tr>
<td class="about_title"><img src="graph/about.gif" width="18" height="16" hspace="0" vspace="0" align="absmiddle">&nbsp;<#SW_About_Repeater#></td>
</tr>
<tr>
<td height="220" valign="top" bordercolor="#FFFFFF"><p class="style2"><#SW_About_Repeater_Message#></p><br><br><br>
<script>
if (nav)
{if (document.form.preferred_lang.value=="EN")
...
{if (document.form.preferred_lang.value=="EN" || document.form.preferred_lang.value=="JP" || document.form.preferred_lang.value=="TR")
...
<!--
<table width="540" height="30"  border="0" cellpadding="0" cellspacing="0" bgcolor="#D1DEE9" style="border-top:2px solid #999; border-bottom:1px dotted #666; font-size:12px; color:#003366;">
<tr>
<td align="left" onMouseOver="return overlib('<#Desc_SW_Router_Mode#>', LEFT);" onMouseOut="return nd();">&nbsp;&nbsp;&nbsp;<strong><#SW_Router_Mode#></strong>&nbsp;<input type="radio" name="wan_nat_x" value="1" onClick="return change_common_radio(this, 'IPConnection', 'wan_nat_x', '1')" <% nvram_match_x("IPConnection","wan_nat_x", "1", "checked"); %>><#SW_Radio_Enable#><input type="radio" name="wan_nat_x" value="0" onClick="return change_common_radio(this, 'IPConnection', 'wan_nat_x', '0')" <% nvram_match_x("IPConnection","wan_nat_x", "0", "checked"); %>><#SW_Radio_Disable#></td>
</tr>
</table>
-->
...
<p align="center"><input type="button" name="button4" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px;" value="<#CTL_ok#>" onClick="submit_ure();show_restart();">
