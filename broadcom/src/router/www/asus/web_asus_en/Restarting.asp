...
if (document.form.RESTORE.value=="1")
time=16;
else if (document.form.mode_ex.value!="ap")
time=18;
}
</script>
</head>
...
<input type="hidden" name="RESTORE" value="<% nvram_get_x("","restore"); %>">
...
<tr>
<td width="652" height="25" bgcolor="#FFFFFF" colspan="2"><font face="Arial"><#SAVE_restart_desc#></font></td>
</tr>
<tr>
