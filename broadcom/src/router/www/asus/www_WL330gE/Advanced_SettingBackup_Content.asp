...
<#BK_desc31#> <a href="setting.CFG">HERE</a>. <#BK_desc32#>
...
<input class="inputSubmit" style="cursor:pointer;" name="file" size="20" type="file" ></td>
</tr>
<tr>
<td class="content_header_td"></td><td class="content_input_td" width="595">
<p align="left"><input class="inputSubmit" style="cursor:pointer;" type="submit" onClick="onSubmitCtrlOnly(this, 'Upload')" value="<#CTL_upload#>">
</p>
</td>
</tr>
</table>
