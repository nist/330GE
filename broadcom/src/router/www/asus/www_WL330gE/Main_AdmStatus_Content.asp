...
<body onLoad="load_body();document.form.SystemCmd.focus();" onunLoad="return unload_body();">
...
<tr class="content_header_tr">
<td class="content_header_td">System Command:</td>
...
<tr class="content_header_tr">
<td colspan="2">
<textarea class="content_log_td" cols="63" rows="10" wrap="off" readonly="1">
...
<div align="center">
<font face="Arial">
<input class=inputSubmit onClick="onSubmitCtrl(this, ' Refresh ')" type="submit" value="<#CTL_refresh#>" name="action">
</font>
</div>
</td>
</tr>
