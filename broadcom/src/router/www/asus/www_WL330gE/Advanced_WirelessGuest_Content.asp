...
<input type="hidden" name="current_page" value="Advanced_WirelessGuest_Content.asp">
<input type="hidden" name="next_page" value="Advanced_WAdvanced_Content_GW.asp">
...
<input type="hidden" name="lan_ipaddr" value="<% nvram_get_x("WLANConfig11b","lan_ipaddr"); %>">
<input type="hidden" name="lan_netmask" value="<% nvram_get_x("WLANConfig11b","lan_netmask"); %>">
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('<#WLANConfig11b_GEnable_itemdesc#>', LEFT);" onMouseOut="return nd();"><#WLANConfig11b_GEnable_itemname#>
</td><td class="content_input_td"><input type="radio" value="1" name="wl_guest_enable" class="content_input_fd" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_guest_enable', '1')" <% nvram_match_x("WLANConfig11b","wl_guest_enable", "1", "checked"); %>><#RADIO_TEXT_YES#></input><input type="radio" value="0" name="wl_guest_enable" class="content_input_fd" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_guest_enable', '0')" <% nvram_match_x("WLANConfig11b","wl_guest_enable", "0", "checked"); %>><#RADIO_TEXT_NO#></input></td>
</tr>
<tr>
...
</td><td class="content_input_td"><script language="JavaScript" type="text/javascript" src="md5.js"></script><input type="text" maxlength="63" class="content_input_fd" size="32" name="wl_guest_wpa_psk_1" value="<% nvram_get_x("WLANConfig11b","wl_guest_wpa_psk_1"); %>" onKeyUp="return is_wlphrase('WLANConfig11b', 'wl_guest_wpa_psk_1', this)" onBlur="return validate_wlphrase('WLANConfig11b', 'wl_guest_wpa_psk_1', this)"></td>
</tr>
<tr>
...
</td><td class="content_input_td"><input type="text" maxlength="15" class="content_input_fd" size="15" name="lan1_ipaddr" value="<% nvram_get_x("WLANConfig11b","lan1_ipaddr"); %>" onChange="page_changed()" onBlur="return validate_ipaddr(this, 'lan1_ipaddr')" onKeyPress="return is_ipaddr(this)" onKeyUp="change_ipaddr(this)"></td>
</tr>
<tr>
...
</td><td class="content_input_td"><input type="text" maxlength="15" class="content_input_fd" size="15" name="lan1_netmask" value="<% nvram_get_x("WLANConfig11b","lan1_netmask"); %>" onChange="page_changed()" onBlur="return validate_ipaddr(this, 'lan1_netmask')" onKeyPress="return is_ipaddr(this)" onKeyUp="change_ipaddr(this)"></td>
</tr>
<tr>
<td class="content_header_td"><#WLANConfig11b_GDHCPServerConfigurable_itemname#>
</td><td class="content_input_td"><input type="radio" value="1" name="dhcp1_enable_x" class="content_input_fd" onClick="return change_common_radio(this, 'WLANConfig11b', 'dhcp1_enable_x', '1')" <% nvram_match_x("WLANConfig11b","dhcp1_enable_x", "1", "checked"); %>><#RADIO_TEXT_YES#></input><input type="radio" value="0" name="dhcp1_enable_x" class="content_input_fd" onClick="return change_common_radio(this, 'WLANConfig11b', 'dhcp1_enable_x', '0')" <% nvram_match_x("WLANConfig11b","dhcp1_enable_x", "0", "checked"); %>><#RADIO_TEXT_NO#></input></td>
</tr>
<tr>
...
</td><td class="content_input_td"><input type="text" maxlength="15" class="content_input_fd" size="15" name="dhcp1_start" value="<% nvram_get_x("WLANConfig11b","dhcp1_start"); %>" onChange="page_changed()" onBlur="return validate_ipaddr(this, 'dhcp1_start')" onKeyPress="return is_ipaddr(this)" onKeyUp="change_ipaddr(this)"></td>
</tr>
<tr>
...
</td><td class="content_input_td"><input type="text" maxlength="15" class="content_input_fd" size="15" name="dhcp1_end" value="<% nvram_get_x("WLANConfig11b","dhcp1_end"); %>" onChange="page_changed()" onBlur="return validate_ipaddr(this, 'dhcp1_end')" onKeyPress="return is_ipaddr(this)" onKeyUp="change_ipaddr(this)"></td>
</tr>
<tr>
...
</td><td class="content_input_td"><input type="text" maxlength="5" size="5" name="lan1_lease" class="content_input_fd" value="<% nvram_get_x("WLANConfig11b", "lan1_lease"); %>" onChange="page_changed()" onBlur="validate_range(this, 1, 86400)" onKeyPress="return is_number(this)"></td>
</tr>
</table>
</td>
</tr>
